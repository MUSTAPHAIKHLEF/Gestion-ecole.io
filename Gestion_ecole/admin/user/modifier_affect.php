...
<button class="btn btn-warning" type="submit" name="searchBtn" ><i class="fa fa-search"></i></button>
    <a class="btn btn-dark me-2" href="modifier_affect.php"><i class="fa fa-window-close"></i></a>
    <a class="btn btn-success me-2" href="../affectations.php"><i class="fa fa-undo-alt"></i></a>
    </div>
    </form>';
 if(isset($_GET['searchBtn'])){ 
    $searchResult = $database->prepare("SELECT * FROM gestion_personnels t1, affectations t2 
    WHERE t1.N_CNIE=t2.N_CNIE AND t1.N_CNIE LIKE :n_cnie");
    ...
    echo  "<th>PRENOM</th>";
    echo  "<th>N_CNIE</th>";
    echo  "<th>DATE_ENTREE</th>";
    echo  "<th>DATE_SORTIE</th>";
    echo  "<th>ECOLE_AFF</th>";
    echo  "<th>REF_AFF</th>";
    echo  "<th>DATE_REFF</th>";
    ...
    foreach($searchResult as $result){
        ...
        echo "<td> ".$result['DATE_ENTREE'] ."</td>";
        echo "<td> ".$result['DATE_SORTIE'] ."</td>";
        echo "<td> ".$result['ECOLE_AFFECTATION'] ."</td>";
        echo "<td> ".$result['REF_AFFECTATION'] ."</td>";
        echo "<td> ".$result['DATE_REF'] ."</td>";
